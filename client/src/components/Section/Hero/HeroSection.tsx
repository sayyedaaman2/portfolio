...
export default function HeroSection() {
  return (
    <section id="hero" className="">
      <div className="container  grid grid-rows-2 justify-center   lg:justify-between   lg:grid-rows-1 lg:grid-cols-2  gap-5 h-full">
        <div className="img_section relative  md:h-84 lg:h-96 lg:order-2 ">
