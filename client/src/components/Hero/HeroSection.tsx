...
export default function HeroSection() {
  return (
    <section id="hero" className="h-screen">
      <div className="container   grid grid-rows-2 justify-center lg:justify-between   lg:grid-rows-1 lg:grid-cols-2  gap-5 my-10">
        <div className="img_section relative md:h-120 lg:h-96 lg:order-2 ">
